...
# NG 1
NG_1 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_1_5_6.csv")
NG_2 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_1_7_8.csv")
#OK_3 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_0_5_6.csv")
#OK_4 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_0_7_8.csv")
#OK_5 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_0_9_10.csv")
...
#NG_4["class"] = 0
#NG_5["class"] = 0
#NG_1.loc[ NG_1["index(welding)"]==4 , "class" ] = 1

NGs_1 = pd.concat([NG_1, NG_2])

# NG 2
NG_1 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_2_1_2.csv")
NG_2 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_2_3_4.csv")
NG_3 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_2_5_6.csv")
NG_4 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_2_7_8.csv")
NG_5 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_2_9_10.csv")
...
# NG 3
NG_1 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_3_1_2.csv")
NG_2 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_3_3_4.csv")
NG_3 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_3_5_6.csv")
NG_4 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_3_7_8.csv")
NG_5 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_3_9_10.csv")
...
NG_5["class"] = 0
'''
NG_1.loc[ NG_1["index(welding)"]==0 , "class" ] = 1

NG_2.loc[ NG_1["index(welding)"]==0 , "class" ] = 1
NG_2.loc[ NG_1["index(welding)"]==1 , "class" ] = 1
NG_2.loc[ NG_3["index(welding)"]==2 , "class" ] = 1
NG_2.loc[ NG_3["index(welding)"]==3 , "class" ] = 1
NG_2.loc[ NG_3["index(welding)"]==4 , "class" ] = 1
NG_2.loc[ NG_3["index(welding)"]==5 , "class" ] = 1
NG_2.loc[ NG_4["index(welding)"]==7 , "class" ] = 1

NG_3.loc[ NG_1["index(welding)"]==0 , "class" ] = 1
NG_3.loc[ NG_1["index(welding)"]==3 , "class" ] = 1
NG_3.loc[ NG_3["index(welding)"]==4 , "class" ] = 1
NG_3.loc[ NG_3["index(welding)"]==7 , "class" ] = 1

NG_4.loc[ NG_1["index(welding)"]==0 , "class" ] = 1
NG_4.loc[ NG_1["index(welding)"]==3 , "class" ] = 1
NG_4.loc[ NG_3["index(welding)"]==4 , "class" ] = 1
NG_4.loc[ NG_3["index(welding)"]==7 , "class" ] = 1

NG_5.loc[ NG_4["index(welding)"]==0 , "class" ] = 1
NG_5.loc[ NG_4["index(welding)"]==1 , "class" ] = 1
NG_5.loc[ NG_4["index(welding)"]==3 , "class" ] = 1
NG_5.loc[ NG_5["index(welding)"]==7 , "class" ] = 1
'''
NGs_3 = pd.concat([NG_1, NG_2, NG_3, NG_4, NG_5])


# NG 4
NG_1 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_4_9_10.csv")
#OK_2 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_3_3_4.csv")
#OK_3 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_3_5_6.csv")
#OK_4 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_3_7_8.csv")
#OK_5 = pd.read_csv("D:/data/LGC-welding/image/20200529-2nd/Cu/gap/200524_3_9_10.csv")
...
for iii in range(1):
    ...
    if imageId == 1 :
        ...
        plt.plot(
            ...
            "ro", label="NG", markersize=markSize
        )
